        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{url('auth')}}" id="quickForm" >
				  @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Login</button>  <a href="{{url('register')}}" class="btn btn-primary">Register Here</a>
                </div>
